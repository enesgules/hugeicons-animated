...
const shaftVariants: Variants = {
  ...
  animate: {
    // shaft compresses as the head launches, then stretches back
    d: ['M18.5 12L4.99997 12', 'M18.5 12L9.5 12', 'M18.5 12L4.99997 12'],
...
const headVariants: Variants = {
  normal: { translateX: 0 },
  animate: {
    // head leads the motion — quick launch, softer settle
    translateX: [0, 3.5, 0],
...
const ArrowRight02Icon = forwardRef<
  ArrowRight02IconHandle,
  ArrowRight02IconProps
