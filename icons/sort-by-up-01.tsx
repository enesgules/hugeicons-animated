...
export interface SortByUp01IconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface SortByUp01IconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const SortByUp01Icon = forwardRef<SortByUp01IconHandle, SortByUp01IconProps>(
