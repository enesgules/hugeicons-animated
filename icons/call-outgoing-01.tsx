...
export interface CallOutgoing01IconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface CallOutgoing01IconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const CallOutgoing01Icon = forwardRef<CallOutgoing01IconHandle, CallOutgoing01IconProps>(
