...
export interface Bookmark01IconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface Bookmark01IconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const Bookmark01Icon = forwardRef<Bookmark01IconHandle, Bookmark01IconProps>(
