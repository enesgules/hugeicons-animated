...
const pathVariants: Variants = {
  normal: { opacity: 1, transform: 'translate(0, 0) rotate(0deg)' },
  animate: (i: number) =>
    i === 2
      ? {
          transform: [
            'translate(0, 0) rotate(0deg)',
            'translate(-1.8px, 1.1px) rotate(-3deg)',
            'translate(0.45px, -0.25px) rotate(0.8deg)',
            'translate(0, 0) rotate(0deg)',
          ],
      ...
      : {
          transform:
            i === 0
              ? ['rotate(0deg) translateY(0px)', 'rotate(5deg) translateY(-1.3px)', 'rotate(-1deg) translateY(0.3px)', 'rotate(0deg) translateY(0px)']
              : ['scale(0.5)', 'scale(1.2)', 'scale(0.96)', 'scale(1)'],
          transformOrigin: i === 0 ? '14px 10px' : '15.37px 7.43px',
          transition: { duration: 0.56, delay: i * 0.07, ease: [0.23, 1, 0.32, 1] },
        },
};
