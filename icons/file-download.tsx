...
export interface FileDownloadIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface FileDownloadIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const FileDownloadIcon = forwardRef<FileDownloadIconHandle, FileDownloadIconProps>(
